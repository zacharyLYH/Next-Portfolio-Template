// To parse this data:
//
//   import { Convert, Experience } from "./file";
//
//   const experience = Convert.toExperience(json);
//
...
export class ConvertExperience {
    ...
    public static experienceToJson(value: Experience): string {
        return JSON.stringify(uncast(value, r("Experience")), null, 2);
    }
}
...
const typeMap: any = {
    Experience: o(
        [
            ...
            { json: "orgName", js: "orgName", typ: u(undefined, "", null) },
            {
                json: "dateStartEnd",
                js: "dateStartEnd",
